...
import site.flyframe.ioc.test.test01.ComponentTest;
import site.flyframe.ioc.test.test01.ServiceTest;
import site.flyframe.ioc.test.test01.Test01;
import site.flyframe.ioc.test.test01.TestClass;
import site.flyframe.ioc.test.test02.ValueTest;
import site.flyframe.ioc.test.test03.SetTest01;
import site.flyframe.ioc.test.test04.ConstructTest;
...
public class ApplicationContextTest {
    ...
    public void setUp() throws Exception {
        ...
        list.add("site.flyframe.ioc.test");
